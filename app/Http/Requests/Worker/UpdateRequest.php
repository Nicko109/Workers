...
class UpdateRequest extends FormRequest
{
    ...
    public function messages()
    {
        return [
            ...
            'surname.required' => 'Это поле нужно заполнить',
            'surname.string' => 'Это поле нужно заполнить',
            'email.string' => 'Это поле нужно заполнить',
            'email.required' => 'Это поле должно быть формата email',
